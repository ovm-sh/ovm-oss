...
# Label: dev-<branch>-<MMDD>-<hash8>. Branch + build date make snapshots
# recognizable in `ovm self list`; the content-hash suffix keeps identity —
# rebuilding identical content on the same day reuses the same version.
